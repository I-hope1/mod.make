...
public class SclLinstener extends InputListener {
	public boolean disabled;
	public float   offset = 10;
	public Element bind;
	public float   defWidth, defHeight, defX, defY, minW, minH;

	public SclLinstener(Element element, float minW, float minH) {
	...
	public boolean touchDown(InputEvent event, float x, float y, int pointer, KeyCode button) {
		...
		scling = false;
		/*try {
			lastCursor = Reflect.get(Core.graphics, "lastCursor");
